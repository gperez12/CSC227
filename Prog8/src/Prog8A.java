/*====================================================================================
 |	Assignment:	Program #8A : Prog8A.java
 ...
 |
 | Description:	This program is used to test PolynomialA.java. This 
 |				program will take all the method created in the PolynomialA
 |				class and test them. 
 |					
...
public class Prog8A {
	public static void main (String [] args)
	{
					...
					System.out.println("Creating a Polynomial, polynomial1.\n");
					PolynomialA polynomial1 = new PolynomialA();
					...
					System.out.println("Creating a Polynomial, polynomial2.\n");
					PolynomialA polynomial2 = new PolynomialA();
					
					// adding a term to polynomial2
					System.out.println("Adding term 3x^2 to the Polynomial");
					polynomial2.addTerm(3, 2);
					System.out.println(polynomial2.toString());
					
					// adding another term to polynomial2
					System.out.println("\nAdding term 0x^2 to the Polynomial");
					polynomial2.addTerm(0, 2);
					System.out.println(polynomial2.toString());
					
					// adding a negative term to polynomial2
					System.out.println("\nAdding term x^2 to the Polynomial");
