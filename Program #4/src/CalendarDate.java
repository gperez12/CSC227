...
public class CalendarDate {
    ...
    |  Pre-condition:  None.
    |
    |  Post-condition: A reference to a calendarDate object will be created with valid 
    ...
    *-------------------------------------------------------------------*/
    ...
    |	         to use in the Babwanis Congruence equation.
    |
    |
    |  Pre-condition:  A reference to a CalendarDate object must be created.
    |
    ...
    *-------------------------------------------------------------------*/
	...
	private int leapYear()
	{
		...
		int leapYear =0, 			//leapYear flag, if set to 1 year is leapyear
		    monthCode = 0, 			//monthCode used for Babwanis Congruence
		    floor, 				//Variable to hold floor calculation for Babwanis Congruence
	...
	floor = ((5*twoLastDigitYear)/4);	//calculates the floor for the Babwanis Congruence

	dayOfWeek = (((Math.floor(floor)+monthCode+day)-2*(twoFirstDigitYear%4)+7)%7); //Babwanis Congruence
    ...
    *-------------------------------------------------------------------*/	
	public String dayOfTheWeek()
	{
		...
		//match value from Babwanis Congruence (dayOfWeek) with proper string
		switch(dayOfWeek)
		{
		case 0: day = "Saturday";
				break; 
